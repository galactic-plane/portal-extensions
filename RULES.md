...
3. **portal-extension-init-auth.js** - GENERATED by C# plugin for authenticated extensions (DO NOT EDIT)
4. **portal-extension-init-noauth.js** - GENERATED by C# plugin for public extensions (DO NOT EDIT)
...
2. **Separates** extensions based on `requiresAuthentication` flag
3. **Generates** two init files:
...
4. **Deploys** extension JS files specified in `deployment.webFiles`
5. **Uploads** scripts to Power Pages tracker code (head):
   ```html
   <!-- Bootstrap Icons -->
...
- C# plugin automatically routes extensions to correct init file based on this flag
...
- `portal-extension-init-auth.js` and `portal-extension-init-noauth.js` are GENERATED - never edit manually
...
├── portal-extension-init-auth.js         # GENERATED - Authenticated extensions (DO NOT EDIT)
├── portal-extension-init-noauth.js       # GENERATED - Public extensions (DO NOT EDIT)
...
- Manually editing `portal-extension-init-auth.js` or `portal-extension-init-noauth.js` (auto-generated)
